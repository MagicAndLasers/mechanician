...
enum ProviderFacts {
    ...
    static let millionTokenSuffixUpgrades: Set<String> = [
        "claude-opus-4-8",
    ]
    ...
    static let nativeMillionTokenModels: Set<String> = [
        "claude-fable-5",
        "claude-fable-5-1",
        "claude-mythos-5",
        "claude-mythos-5-1",
    ...
    static let routesWithoutPreviewSurfaces: Set<String> = [
        "vertex",
        "bedrock",
        "foundry",
    ]
    ...
    static let thirdPartyMillionTokenModels: Set<String> = [
        "claude-sonnet-5",
    ]
    ...
    static let thirdPartyModelIDPrefixes: [String] = [
    ...
    static let thirdPartyRoutes: Set<String> = [
        "vertex",
        "bedrock",
        "foundry",
    ]
